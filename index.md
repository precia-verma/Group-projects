...
<div style="display: flex; flex-wrap: wrap; gap: 10px;">
 ...
 color: black; padding: 10px 20px; border-radius: 5px; font-weight: bold;">
    ...
    <a href="https://precia-verma.github.io/Group-projects/mansion2" style="background-color: #2b4635ff; color: #f4e6ccff; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-weight: bold;">
    Spooky Forest Game 
    </a>
</div>
